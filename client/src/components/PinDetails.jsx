  ...
  return (
    <>
      ...
      >
        ...
        <div className="w-full p-5 flex-l xl:min-w-620">
          ...
          <div className="flex flex-wrap mt-6 gap-3 items-center">
            ...
            <input
              type="text"
              className="flex-1 mt-5 border-gray-100 outline-none border-2 p-2 rounded-2xl focus:border-gray-300"
            ...
            <button
              type="button"
              className="bg-green-500 text-white rounded-full px-6 py-2 font-semibold text-base outline-none mt-5"
              onClick={addComment}
            >
